...
final class EventAdminController extends AbstractController
{
    ...
    #[Route('/{id}/participants', name: 'admin_events_participants')]
    ...
    #[Route('/{id}/participants/{participationId}/accepter', name: 'admin_events_participant_accept', methods: ['POST'])]
    ...
    #[Route('/{id}/participants/{participationId}/supprimer', name: 'admin_events_participant_delete', methods: ['POST'])]
